make: boot.s kernel/kernel.c kernel/terminal/terminal.c kernel/libc/string.c kernel/libc/stdio.c kernel/libc/Math.c linker.ld
	...
	../cross/bin/i686-elf-gcc -c kernel/kernel.c kernel/terminal/terminal.c kernel/libc/string.c kernel/libc/stdio.c kernel/libc/Math.c -std=gnu99 -ffreestanding -O2 -Wall -Wextra
